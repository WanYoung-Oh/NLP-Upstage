...
try:
    ...
    pass
from typing import Any, List, Optional, Tuple, Union, Dict, Set, Callable
from transformers.models.qwen3_5_moe.modeling_qwen3_5_moe import (F, Callable, Any, Optional, torch, nn, init, ACT2FN, Cache, GenerationMixin, FlashAttentionKwargs, ModelOutput, BaseModelOutputWithPooling, MoeCausalLMOutputWithPast, ROPE_INIT_FUNCTIONS, dynamic_rope_update, ALL_ATTENTION_FUNCTIONS, PreTrainedModel, Unpack, TransformersKwargs, can_return_tuple, is_flash_attention_requested, maybe_autocast, Qwen3_5MoeConfig, Qwen3_5MoeTextConfig, Qwen3_5MoeVisionConfig, causal_conv1d_fn, causal_conv1d_update, FusedRMSNormGated, chunk_gated_delta_rule, fused_recurrent_gated_delta_rule, logger, __name__, Qwen3_5MoeDynamicCache, is_fast_path_available, Qwen3_5MoePreTrainedModel, Qwen3_5MoeModel, Qwen3_5MoeCausalLMOutputWithPast, Qwen3_5MoeForConditionalGeneration, Qwen3_5MoeGatedDeltaNet)

@torch.compile(fullgraph = True, dynamic = True, options = torch_compile_options)
def Qwen3_5MoeVisionRotaryEmbedding_forward(self, seqlen: int) -> torch.Tensor:
...
class Qwen3_5MoeVisionRotaryEmbedding(nn.Module):
    ...
    def forward(self, seqlen: int) -> torch.Tensor:
        return Qwen3_5MoeVisionRotaryEmbedding_forward(self, seqlen=seqlen)


@torch.compile(fullgraph = False, dynamic = True, options = torch_compile_options)
@torch.no_grad()
@dynamic_rope_update  # power user: used with advanced RoPE types (e.g. dynamic rope)
def Qwen3_5MoeTextRotaryEmbedding_forward(self, x, position_ids):
...
class Qwen3_5MoeTextRotaryEmbedding(nn.Module):
    ...
    def forward(self, x, position_ids):
        return Qwen3_5MoeTextRotaryEmbedding_forward(self, x=x, position_ids=position_ids)
...
@torch.compile(fullgraph = True, dynamic = True, options = torch_compile_options)
def Qwen3_5MoeRMSNormGated_forward(self, hidden_states, gate=None):
...
class Qwen3_5MoeRMSNormGated(nn.Module):
    ...
    def forward(self, hidden_states, gate=None):
        return Qwen3_5MoeRMSNormGated_forward(self, hidden_states=hidden_states, gate=gate)


@torch.compile(fullgraph = True, dynamic = True, options = torch_compile_options)
def Qwen3_5MoeRMSNorm_forward(self, x):
...
class Qwen3_5MoeRMSNorm(nn.Module):
    ...
    def forward(self, x):
        return Qwen3_5MoeRMSNorm_forward(self, x=x)
...
@torch.compiler.disable(recursive = False)
def Qwen3_5MoeGatedDeltaNet_forward(
    self,
...
class Qwen3_5MoeGatedDeltaNet(nn.Module):
    ...
    def forward(
        ...
        return Qwen3_5MoeGatedDeltaNet_forward(self, hidden_states=hidden_states, cache_params=cache_params, cache_position=cache_position, attention_mask=attention_mask)
...
@torch.compiler.disable(recursive = False)
def Qwen3_5MoeAttention_forward(
    self,
    hidden_states: torch.Tensor,
...
class Qwen3_5MoeAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        return Qwen3_5MoeAttention_forward(self, hidden_states=hidden_states, position_embeddings=position_embeddings, attention_mask=attention_mask, past_key_values=past_key_values, cache_position=cache_position, **kwargs)


@torch.compile(fullgraph = False, dynamic = True, options = torch_compile_options)
def Qwen3_5MoeMLP_forward(self, x):
...
class Qwen3_5MoeMLP(nn.Module):
    ...
    def forward(self, x):
        return Qwen3_5MoeMLP_forward(self, x=x)
...
@torch.compile(fullgraph = True, dynamic = True, options = torch_compile_options)
def Qwen3_5MoeTopKRouter_forward(self, hidden_states):
...
class Qwen3_5MoeTopKRouter(nn.Module):
    ...
    def forward(self, hidden_states):
        return Qwen3_5MoeTopKRouter_forward(self, hidden_states=hidden_states)
...
def sparse_moe_block_forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
    ...
    if isinstance(gate_output, tuple):
        ...
        routing_weights = F.softmax(router_logits, dim=1, dtype = torch.float32).to(router_logits.dtype).to(router_logits.dtype)
...
@torch.compile(fullgraph = False, dynamic = True, options = torch_compile_options)
def Qwen3_5MoeVisionMLP_forward(self, hidden_state):
...
class Qwen3_5MoeVisionMLP(nn.Module):
    ...
    def forward(self, hidden_state):
        return Qwen3_5MoeVisionMLP_forward(self, hidden_state=hidden_state)


@torch.compile(fullgraph = True, dynamic = True, options = torch_compile_options)
def Qwen3_5MoeVisionPatchEmbed_forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
...
class Qwen3_5MoeVisionPatchEmbed(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
        return Qwen3_5MoeVisionPatchEmbed_forward(self, hidden_states=hidden_states)


@torch.compile(fullgraph = False, dynamic = True, options = torch_compile_options)
def Qwen3_5MoeVisionPatchMerger_forward(self, x: torch.Tensor) -> torch.Tensor:
...
class Qwen3_5MoeVisionPatchMerger(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        return Qwen3_5MoeVisionPatchMerger_forward(self, x=x)
...
class Qwen3_5MoeVisionAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        return Qwen3_5MoeVisionAttention_forward(self, hidden_states=hidden_states, cu_seqlens=cu_seqlens, rotary_pos_emb=rotary_pos_emb, position_embeddings=position_embeddings, **kwargs)
...
@torch.compiler.disable(recursive = False)
@can_return_tuple
def Qwen3_5MoeForConditionalGeneration_forward(
    self,
